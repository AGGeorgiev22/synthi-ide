...
const OUTCOMES = [
  {
    ...
    short: "Collisions",
    mechanism: "Shared paths become controlled airspace before two agents mutate them at once.",
    outcome: "Parallel work keeps moving without silent overwrite or merge archaeology.",
  ...
  },
  {
    ...
    short: "Your agent",
    mechanism: "Vectant connects to Codex, Claude Code, Cursor, Gemini CLI, and internal runners.",
    outcome: "Teams add a control plane without replacing the agent workflows they already trust.",
    artifact: "MCP connections, extension hosting, and isolated workspace programs",
...
export function OutcomeChapters() {
  ...
  return (
    <section id="systems" className={styles.outcomes} aria-labelledby="outcomes-title">
                ...
                <div id={`outcome-${outcome.key}`} className={styles.outcomeBody}>
                  <figure>
                    <Image
                      ...
                      style={{ objectPosition: outcome.position }}
                    />
                  </figure>
